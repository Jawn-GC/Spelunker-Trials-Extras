meta = {
    name = 'Spelunker Trials: Extras',
    version = '1.2',
    description = 'Bonus Kaizo levels, made with love.',
    author = 'JawnGC',
}

register_option_int("level_selected", "Level number for shortcut door (1 to 15)", 1, 1, 15)
...
--Set level order
levels = {dwelling1, dwelling2, dwelling3, volcana1, volcana2, jungle1, jungle2, tidepool1, tidepool2, temple1, temple2, neobabylon1, neobabylon2, sunkencity1, sunkencity2}
...
replace_drop(DROP.QUILLBACK_BOMBBAG, ENT_TYPE.ITEM_GOLDCOIN)
replace_drop(DROP.QUILLBACK_COOKEDTURKEY, ENT_TYPE.ITEM_GOLDCOIN)
...
local function shortcut_callback()
	return set_pre_tile_code_callback(function(x, y, layer)
		...
		elseif options.level_selected > 15 then
			options.level_selected = 15
		end
